    ...
    <script>
        ...
        function onEstSpecSelect(select) {
            ...
            if (select.value === '__custom__') {
                ...
                specCell.innerHTML = `<input type="text" class="spec-input" placeholder="상세 입력" style="width:100%; padding:4px; border:1px solid #0071e3; border-radius:4px; font-size:11px;">`;
            ...
            if (priceCell) {
                priceCell.textContent = price ? formatNumber(price) : '-';
                priceCell.dataset.price = price || '0';
            }
